...
namespace Core
{
    public class Crypto
    {
        ...
        /// <returns></returns>
        public static string Encript(string ishText, string pass,
               string sol = "irisoft", string cryptographicAlgorithm = "SHA1",
        ...
        /// <param name="keySize"></param>
        /// <returns></returns>
        public static string Decript(string ciphText, string pass,
               string sol = "irisoft", string cryptographicAlgorithm = "SHA1",
               int passIter = 2, string initVec = "a8doSuDitOz1hZe#",
               int keySize = 256)
        {
