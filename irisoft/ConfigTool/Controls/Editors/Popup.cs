...
namespace Configuration.Controls.Editors
{
    ...
    public partial class Popup : ToolStripDropDown
    {
        ...
        public Popup(Control content)
        {
            ...
            content.RegionChanged += delegate(object sender, EventArgs e) { UpdateRegion(); };
        ...
        private bool OnGetMinMaxInfo(ref Message m)
        {
            NativeMethods.MINMAXINFO minmax =
                (NativeMethods.MINMAXINFO) Marshal.PtrToStructure(m.LParam, typeof(NativeMethods.MINMAXINFO));
        ...
        public void PaintSizeGrip(PaintEventArgs e)
        {
            ...
            {
                ControlPaint.DrawSizeGrip(e.Graphics, content.BackColor, clientSize.Width - 0x10,
