...
namespace Configuration.Controls.Editors.Selection_Wrappers
{
    /// <summary>
    ...
    public class ListSelectionWrapper<T> : List<ObjectSelectionWrapper<T>>
    {
        ...
        /// </summary>
        public ListSelectionWrapper(IEnumerable source, string usePropertyAsDisplayName) : this(source, false,
        ...
        {
            return Find(delegate(ObjectSelectionWrapper<T> target) { return target.Item.Equals(Object); });
        }
