...
namespace DbWorkerAndML
{
    internal class Controller
    {
        ...
        internal static void ToStart()
        {
            try
            {
                using (var modelBinance = new ModelBinance(true))
                {
                    // Этап 1 Заливка БД
                    FillDbFromBurse(modelBinance);
                }

                using (var modelBinance = new ModelBinance())
                {
        ...
        /// <summary>Этап 3 Тестируем советы в идеальной сфере </summary>
        internal static void TestAdvicesOnPerfectSphere()
        {
            IOrderedQueryable<Candlestick> sticks;
            var modelBinance = new ModelBinance();
            var closeTime = Converters.GeDateTime(new DateTime(2021, 12, 1));
            sticks = modelBinance.Candlesticks.
        ...
        internal static void CreateAdvices(ModelBinance modelBinance)
        {
        ...
        internal static void FillDbFromBurse(ModelBinance modelBinance)
        {
            /*
                /*
        ...
        private static IEnumerable<Candlestick> GetAllSticks(ModelBinance modelBinance, DateTime fromTime)
        {
            ...
            while (true)
            {
                ...
                modelBinance.Candlesticks.UpdateRange(take.ToArray());
                modelBinance.SaveChanges();
